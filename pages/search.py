...
def show():
    ...
    if st.session_state.search_query:
        books_df = books_df[
            books_df["title"].str.contains(st.session_state.search_query, case=False, na=False)
            | books_df["author"].str.contains(st.session_state.search_query, case=False, na=False)
        ]
    ...
    if st.session_state.year_from > st.session_state.year_to:
        ...
        books_df = books_df[
            books_df["year"].astype(int).between(st.session_state.year_from, st.session_state.year_to)
